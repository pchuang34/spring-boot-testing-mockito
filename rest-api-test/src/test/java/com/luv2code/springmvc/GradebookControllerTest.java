...
public class GradebookControllerTest {
    ...
    @Test
    public void studentInfromationHttpRequest() throws Exception{
    ...
    @Test
    public void studentInfromationHttpRequestEmpty() throws Exception{
    ...
    @Test
    public void createGradeHttpRequestWithStudentNotExist() throws Exception{
        mockMvc.perform(MockMvcRequestBuilders.post("/grades")
                .contentType(APPLICATION_JSON_UTF8)
                .param("grade", "85.00")
                .param("gradeType", "math")
    ...
    @Test
    public void createGradeHttpRequestWithInvalidGrade() throws Exception{
        mockMvc.perform(MockMvcRequestBuilders.post("/grades")
                .contentType(APPLICATION_JSON_UTF8)
                .param("grade", "85.00")
    ...
    @Test
    public void deleteGradeHttpRequestStudentIdNotExist() throws Exception{
    ...
    @Test
    public void deleteGradeHttpRequestWithInvalidGradeType() throws Exception{
        mockMvc.perform(MockMvcRequestBuilders.delete("/grades/{id}/{gradeType}", 1, "engineering"))
                .andExpect(status().is4xxClientError())
                .andExpect(jsonPath("$.status", is(404)))
                .andExpect(jsonPath("$.message", is("Student or Grade was not found")));
    }
